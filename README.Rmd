...
kableExtra::kbl(head(articles[, setdiff(names(articles), "intro")], 5), 
                format = "html",
                caption = "<strong style=\"font-size:18pt\"> The latest 5 articles </strong>", booktabs=T, escape = F) |> 
